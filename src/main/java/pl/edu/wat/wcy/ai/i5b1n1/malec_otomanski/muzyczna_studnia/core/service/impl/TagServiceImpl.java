...
public class TagServiceImpl implements TagService{
    ...
    final static Logger logger = Logger.getLogger(TagServiceImpl.class);

    private UserRepository userRepository;
    private TagRepository tagRepository;

    @Autowired
    public TagServiceImpl(UserRepository userRepository, TagRepository tagRepository) {
    ...
    @Transactional
    public void removeTagFromUser(final String tagName, final String username) {
        Optional<Tag> dbTag = tagRepository.findByName(tagName);
